...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('scorpio.authenticate', () => {
        vscode.window.showInformationMessage('Start Authentication');
        (0, authentication_1.authenticate)("artemis_admin", "artemis_admin");
    }));
}
...
async function authenticate(username, password) {
    const url = `${config_1.base_url}/public/authenticate`;
...
exports.base_url = "http://localhost:9000/api";
